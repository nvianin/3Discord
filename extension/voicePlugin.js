    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        const plugin = (Plugin, Api) => {
            ...
            const {
                TimelineDataSeries,
                TimelineGraphView
            } = WebpackModules.getByProps("TimelineDataSeries");
            ...
            class Graph extends React.Component {
                ...
                componentDidMount() {
                    this.interval = setInterval(() => {
                        if (timeline[this.props.user.id] != null) {
                            this.setState({
                                dataSeries: timeline[this.props.user.id]
                            });
                        }
                    }, 500);
                }
                ...
                handleRenderGraph(e) {
                    if (e != null) {
                        ...
                        this.state.graphView.timeOptions = {
                            timeStyle: "short"
                        };
            ...
            return class VoiceChatPanel extends Plugin {
                ...
                async showChangelog(footer) {
                    try {
                        footer = (await WebpackModules.getByProps("getUser", "acceptAgreements").getUser("264163473179672576")).tag + " | https://discord.gg/yNqzuJa";
                    } finally {
                ...
                onStart() {
                    ...
                    Patcher.instead(VoiceUser.prototype, "render", ({
                        props
                    }, _, e) => {
                    ...
                    Patcher.after(WebpackModules.getByDisplayName("RTCConnectionStatus").prototype, "render", ({
                        props
                    }, _, re) => {
                    ...
                    e.getStats().then(stats => {
                        ...
                        for (let component of components)
                            if (volumeStates[component.props.user.id] != null)
                                component.setState({
                                    volume: volumeStates[component.props.user.id]
                                });
                    });
                }
